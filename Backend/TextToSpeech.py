...
# function to manage Text-to_Speech (TTS) functionality.
...
def TextToSpeech(Text, func=lambda r=None : True):
    ...
    if len(Data) > 4 and len(Text) >= 250:
        ...
        # bhot bada para hai toh wo starting ki 2 lines read karega and fir jo above mentioned responses hai, unme se ek boldega.
...
if __name__ == "__main__":
    while True:
        ...
        # if you want to remove the part ki bade text me sirf 2 lines bolra hai, toh simply in this above line, instead of this one write
